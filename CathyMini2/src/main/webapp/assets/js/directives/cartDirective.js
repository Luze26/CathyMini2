                ...
                '<div id="cartTabs" ng-click="prevent($event)">' + 
                 ...
                 '<div id="cartPanel" ng-click="prevent($event)">' +
                    '<div ng-show="cartOpen">' +
                        ...
                        '<a title="Terminer votre commande" style="margin-top:20px; margin-left: 20px;" class="pull-right btn btn-primary" href="/payment.xhtml">Terminer vos commandes</a></div>'+
                    '</div>' +
                    '<div ng-show="subOpen">' +
                        ...
                        '<a title="Terminer votre commande" style="margin-top:20px" class="pull-right btn btn-primary" href="/payment.xhtml">Terminer votre commandes</a>'+
                    '</div>' +
                 '</div>' +
              '</div>'
  };
