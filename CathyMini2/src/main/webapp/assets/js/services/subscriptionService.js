angular.module('common').factory('subscriptionService', ['$http', '$rootScope', 'consumerService', 'notificationService', function($http, $rootScope, $consumerService, notificationService) {
